...
\item \colorbox{yellow}{Detalhe: posi\c{c}\~ao inicial na vertical \'e $0{,}02\,$ m }
\end{itemize}

Portanto, o deslocamento vertical máximo medido experimentalmente é aproximadamente

\begin{equation}
y_{\max} \approx 0{,}42\,\text{m} - 0{,}02\, = 0{,}40\,\text{m} .
\end{equation}
...
\begin{itemize}
\item O deslocamento vertical máximo observado no experimento é aproximadamente \(0{,}40\,\text{m}\).

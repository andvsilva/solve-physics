...
Para calcular a resist\^encia equivalente do circuito podemos usar a 
corrente ($I = 6\,A$) e a tens\~ao total ($U_{total} = 15\,\text{V}$)

\[
U_{total} = R_{eq} . I \rightarrow R_{eq} = \frac{U_{total}}{I} = \frac{15}{6} = 2{,}5\,\Omega
\]
...
\textcolor{red}{Outra forma de resolver:}

Como a corrente total do circuito \'e $I = 6\,A$ e a tens\~ao no resistor R 
e l\^ampada \'e $U_R = U_L = 10\,\text{V}$, podemos determinar que a
corrente el\'etrica no resistor \'e 5 A e 1 A na l\^ampada com resist\^encia
de 10V/1A = 10 $\Omega$. 
...
\[
\frac{1}{R_{par}} = \frac{1}{2} + \frac{1}{10}
= \frac{5 + 1}{10} = \frac{6}{10}
\]

\[
R_{par} = \frac{10}{7} \approx 1{,}67\,\Omega
\]
...
\[
R_{eq} = 0{,}83 + 1{,}67 = 2{,}54\,\Omega
\]

\textbf{Resposta:} $R_{eq} \approx 2{,}5\,\Omega$
...
Sendo:
\[
hc = 2 \times 10^{-16} \ \text{J}\cdot\text{nm}
\quad \text{e} \quad
\lambda_{\text{vermelha}} = 800 \ \text{nm}
\]

\[
E_{f\'oton} = \frac{2 \times 10^{-16}}{800} \ (\text{J}) 
\quad \Rightarrow \quad
E_{f\'oton} = 2{,}5 \times 10^{-19} \ \text{J}
\]
